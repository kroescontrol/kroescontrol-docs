...
<div style={{display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '30px'}}>
  ...
  <div style={{flex: '1 1 280px', minWidth: '280px'}}>
    <div style={{minHeight: '60px', display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
      ...
      <span>Voor donkere achtergronden waar geen kleur nodig is maar wel onderscheiding gewenst is.</span>
    </div>
  ...
  <div style={{flex: '1 1 280px', minWidth: '280px'}}>
    <div style={{minHeight: '60px', display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
      <h3>Wit Logo</h3>
      <div>Te gebruiken op donkere of kleurrijke achtergronden waar maximum contrast vereist is.</div>
    </div>
...
<div style={{display: 'flex', flexWrap: 'wrap', gap: '20px', marginBottom: '30px'}}>
  ...
  <div style={{flex: '1 1 280px', minWidth: '280px'}}>
    <div style={{minHeight: '60px', display: 'flex', flexDirection: 'column', justifyContent: 'center'}}>
      ...
      <div>Voor donkere achtergronden waar geen kleur nodig is maar wel onderscheiding gewenst is.</div>
    </div>
    <div style={{backgroundColor: 'rgb(51, 51, 51)', padding: '20px', borderRadius: '5px', height: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '15px'}}>
